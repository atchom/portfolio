  ...
  en: {
      ...
      items: [
        {
          ...
          missions: [
            ...
            "Design of AI-enhanced medical pre-consultation solution with real-time communication channels, orchestrated through Docker and reverse proxies.",
    ...
    projects: {
      ...
      items: [
        {
          key: "arkivio",
          title: "ARKIVIO – Intelligent Document Archive",
          desc:"Cross-platform Android app (mobile & web) for smart document archiving: real-time scan pre-classification, hybrid lexical/semantic search with RRF, RAG assistant with cited sources, entity-based timeline and knowledge graph, and a biometric vault with automatic masking of sensitive data. Auto-adapts vocabulary, currency and recognized documents to the user's country.",
          image:
            "images/Arkivio.png",
          link: "#projects",
          tags: [
        ...
        {
          key: "amec",
          title: "AMEC – Association Management App",
          desc:"Multi-module mobile app (Android & iOS) for the Cameroon Teachers' Association, covering its 10 modules: development actions, tontine, cash facility, AMEC-BANK, social and solidarity funds, GIC vision, FIS, construction and community life. Offline-first architecture (Drift/SQLite) with role-based access control, business logic for interests, penalties and repayment schedules, PDF exports, and a production-ready Supabase/PostgreSQL backend.",
          image:
            "images/amec2.jpg",
          link: "#projects",
          tags: [
  ...
  fr: {
      ...
      items: [
        {
          ...
          missions: [
            ...
            "Conception de solution de pré-consultation médicale enrichie par IA, avec canaux de communication temps réel, orchestrés via Docker et reverse-proxy.",
    ...
    projects: {
      ...
      items: [
        {
          key: "arkivio",
          title: "ARKIVIO – Système d'archives intelligent",
          desc:
            "Application multi-plateforme (mobile & web) d'archivage documentaire intelligent : scan avec pré-classification en temps réel, recherche hybride lexicale/sémantique avec RRF, assistant RAG à sources citées, timeline et graphe de connaissances reliant les entités, et coffre-fort biométrique avec masquage automatique des données sensibles. Le lexique, la devise et les documents reconnus s'adaptent automatiquement au pays de l'utilisateur.",
          image:
            "images/Arkivio.png",
          link: "#projects",
          tags: [
        ...
        {
          key: "amec",
          title: "AMEC – Application de gestion associative",
          desc:
            "Application mobile multi-modules (Android & iOS) pour l'Amicale des Enseignants du Cameroun, couvrant ses 10 modules : actions de développement, tontine, facilité de caisse, AMEC-BANK, Effort Social et Solidaire, AMEC-VISION (GIC), FIS, construction et vie associative. Architecture offline-first (Drift/SQLite) avec contrôle d'accès par rôle (RBAC), logique métier des intérêts, pénalités et échéanciers, exports PDF, et un backend Supabase/PostgreSQL prêt pour la production.",
          image:
            "images/amec2.jpg",
          link: "#projects",
          tags: [
